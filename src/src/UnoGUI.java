...
//-------------------------------------------DISCARD INFO-----------------------------------------
     ...
     * @param players
     */
    public void Leaderboard(ArrayList<src.Player> players) {
    ...
    public void discardInfo(src.Card card, boolean isDarkMode){
        if (isDarkMode) {
    ...
    public void buildDeck() {
        ...
        URL cardImageURL = getClass().getResource(Card.DECK_FILE_NAME);
        ImageIcon image = new ImageIcon(cardImageURL);
    ...
    public void buildDiscard() {
        ...
        // Use the DECK_FILE_NAME constant to get the specific image URL
        URL cardImageURL = getClass().getResource(Card.DECK_FILE_NAME);
        System.out.println("Image path: " + cardImageURL);

        updateDiscard(cardImageURL);
     ...
     */
    /**
     * Updates the discard button with the specified URL.
     *
     * @param imageURL The URL of the card image to display on the discard button.
     */
    public void updateDiscard(URL imageURL) {
     ...
     */
    public void updatePlayerCardsRemove(int buttonToRemove, src.Hand hand) {
    ...
    public void addPlayCardListener(src.Hand hand, ActionListener listenforCardtoPlay) {
        for (int i = 0; i < hand.getSize(); i++) {
            JButton button = playerCards.get(i);
            button.setName(Integer.toString(i));
    ...
    public void updatePlayerInputFields(ArrayList<src.Player> players){
